...
from escola.views import AlunosViewSet, CursosViewSet, ListaMatriculasAluno, MatriculasViewSet
...
urlpatterns = [
    ...
    path('aluno/<int:pk>/matriculas/', ListaMatriculasAluno.as_view(), name='aluno_matriculas')
]
